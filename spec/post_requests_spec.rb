describe 'POST Requests' do
  ...
  it 'can make simple POST requests' do
    ...
    HTTP.post('http://example.com/widgets')
  ...
  it 'can submit a JSON request body' do
    ...
    HTTP.post('http://example.com/widgets', json: { name: 'Foobar Widget' })
  ...
  it 'can submit form data as request body' do
    ...
    HTTP.post('http://example.com/widgets', form: { name: 'Foobar Widget' })
  ...
  it 'can specify custom content type' do
    ...
    HTTP.post('http://example.com/widgets', headers: headers, json: json)
  ...
  it 'returns a response with the correct status code, headers, and parsed JSON object' do
    ...
    HTTP.post('http://example.com/widgets') do |response|
      @response = response
    end
